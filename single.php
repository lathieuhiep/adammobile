...
$adammobile_single_sidebar    =   $adammobile_options['adammobile_blog_single_sidebar'];

if ( $adammobile_single_sidebar  == 1 ) :
    $adammobile_col_not_sidebar = 'col-md-12';
else:
    $adammobile_col_not_sidebar = 'col-md-9';
endif;
...
<div class="site-container site-single">
    <div class="container">
        <div class="row">
            ...
            if( $adammobile_single_sidebar == 2 ):
                get_sidebar();
            endif;

            ?>

            <div class="<?php echo esc_attr( $adammobile_col_not_sidebar ); ?>">
                <?php
            ...
            if( $adammobile_single_sidebar == 3 ):
                get_sidebar();
            endif;
